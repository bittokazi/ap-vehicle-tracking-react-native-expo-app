                                    ...
                                    <View style={styles.topBarWrapper}>
                                        <View style={styles.topBarInfo}>
                                            <View style={styles.topBarInfoRow}>
                                                <Text style={styles.styleOngoing}>{item.roleEntity.title}</Text>
                                            
                                                {
                                                    item.userCounterEntity!=null &&
                                                        <Text style={styles.styleCompleted}>{item.userCounterEntity.title}</Text>
                                                }
                                            </View>
                                        </View>
                                        {/* <View style={styles.topBarInfo}>
                                    ...
                                    <View style={styles.contentWrapper}>
                                        <View style={styles.contentSectionLeft}>
                                            ...
                                            <View style={styles.contentColumnRight}>
                                                <Text style={styles.contentTextLeft}>{item.firstname}</Text>
                                                <Text style={styles.contentTextLeftLower}>{item.username}</Text>
                                            </View>
                                        </View>
                                        <View style={styles.contentSectionLeft}>
                                            <View style={styles.contentColumnRight}>
                                                <Text style={styles.contentTextLeft}>{item.lastname}</Text>
                                                <Text style={styles.contentTextLeftLower}>{item.email}</Text>
                                            </View>
                                        </View>
                                    </View>
                                </View>
